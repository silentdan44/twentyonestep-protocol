...
class MDStep:
    ...
    def __init__(self,
        ...
        if any(not isinstance(arg, Quantity) for arg in [temperature, time]):
            raise TypeError("Arguments 'temperature' and 'time' should be instances of openmm.unit.Quantity")
        
        if not isinstance(simulation, Simulation):
            raise TypeError("Argument 'simulation' should be an instance of openmm.app.Simulation")
        
        if pressure is not None and not isinstance(pressure, Quantity):
            raise TypeError("Argument 'pressure' should be an instance of openmm.unit.Quantity or None")
    ...
    def _set_barostat(self, frequency: int):
        ...
        if self.pressure is not None:
            system.addForce(MonteCarloBarostat(self.pressure, self.temperature, frequency))
...
class TwentyOneStepProtocol:
    ...
    def __init__(self,
        ...
        if not isinstance(max_pressure, Quantity):
            raise TypeError("Argument 'max_pressure' should be an instance of openmm.unit.Quantity")
    ...
    def _generate_schedule(self, max_pressure: Quantity):
        """
        ...
        self.schedule = [
            {'temperature': 600 * unit.kelvin, 'pressure': None, 'time': 50 * unit.picosecond, 'name': 'md1'},
            {'temperature': 300 * unit.kelvin, 'pressure': None, 'time': 50 * unit.picosecond, 'name': 'md2'},
            {'temperature': 300 * unit.kelvin, 'pressure': max_pressure * 0.02, 'time': 50 * unit.picosecond, 'name': 'md3'},
            {'temperature': 600 * unit.kelvin, 'pressure': None, 'time': 50 * unit.picosecond, 'name': 'md4'},
            {'temperature': 300 * unit.kelvin, 'pressure': None, 'time': 100 * unit.picosecond, 'name': 'md5'},
            {'temperature': 300 * unit.kelvin, 'pressure': max_pressure * 0.6, 'time': 50 * unit.picosecond, 'name': 'md6'},
            {'temperature': 600 * unit.kelvin, 'pressure': None, 'time': 50 * unit.picosecond, 'name': 'md7'},
            {'temperature': 300 * unit.kelvin, 'pressure': None, 'time': 100 * unit.picosecond, 'name': 'md8'},
            {'temperature': 300 * unit.kelvin, 'pressure': max_pressure, 'time': 50 * unit.picosecond, 'name': 'md9'},
            {'temperature': 600 * unit.kelvin, 'pressure': None, 'time': 50 * unit.picosecond, 'name': 'md10'},
            {'temperature': 300 * unit.kelvin, 'pressure': None, 'time': 100 * unit.picosecond, 'name': 'md11'},
            {'temperature': 300 * unit.kelvin, 'pressure': max_pressure * 0.5, 'time': 5 * unit.picosecond, 'name': 'md12'},
            {'temperature': 600 * unit.kelvin, 'pressure': None, 'time': 5 * unit.picosecond, 'name': 'md13'},
            {'temperature': 300 * unit.kelvin, 'pressure': None, 'time': 10 * unit.picosecond, 'name': 'md14'},
            {'temperature': 300 * unit.kelvin, 'pressure': max_pressure * 0.1, 'time': 5 * unit.picosecond, 'name': 'md15'},
            {'temperature': 600 * unit.kelvin, 'pressure': None, 'time': 5 * unit.picosecond, 'name': 'md16'},
            {'temperature': 300 * unit.kelvin, 'pressure': None, 'time': 10 * unit.picosecond, 'name': 'md17'},
            {'temperature': 300 * unit.kelvin, 'pressure': max_pressure * 0.01, 'time': 5 * unit.picosecond, 'name': 'md18'},
            {'temperature': 600 * unit.kelvin, 'pressure': None, 'time': 5 * unit.picosecond, 'name': 'md19'},
            {'temperature': 300 * unit.kelvin, 'pressure': None, 'time': 10 * unit.picosecond, 'name': 'md20'},
            {'temperature': 300 * unit.kelvin, 'pressure': 1 * unit.bar, 'time': 800 * unit.picosecond, 'name': 'md21'}
        ]
    ...
    def run(self, barostat_frequency:int = 500):
        ...
        if not isinstance(barostat_frequency, int):
            raise TypeError("Argument 'barostat_frequency' should be an instance of int")
        
        if not self.schedule:
            raise RuntimeError("Schedule is empty. Probably an error ocured during schedule generation.")
